...
#[ORM\Entity(repositoryClass: 'App\Repository\KnowFromRepository')]
class KnowFrom
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\OneToMany(targetEntity: 'App\Entity\Attender', mappedBy: 'knowFrom')]
    private $attenders;
    ...
    public function removeAttender(Attender $attender): self
    {
        if ($this->attenders->contains($attender)) {
            ...
            if ($attender->getKnowFrom() === $this) {
                $attender->setKnowFrom(null);
            }
        }
